...
class StorageBackendFactory:
    ...
    def _create_chromadb_backend(self, config: Dict[str, Any]):
        from context_lab.storage.backends.chromadb_backend import ChromaDBBackend
        return ChromaDBBackend()
    
    def _create_vikingdb_backend(self, config: Dict[str, Any]):
        from context_lab.storage.backends.vikingdb_backend import VikingDBBackend
        return VikingDBBackend()
    
    def _create_sqlite_backend(self, config: Dict[str, Any]):
        from context_lab.storage.backends.sqlite_backend import SQLiteBackend
