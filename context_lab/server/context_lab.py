...
"""
Context Lab main class - system entry point integrating all components.
...
from context_lab.models.context import RawContextProperties, ProcessedContext
from context_lab.utils.logging_utils import get_logger
from context_lab.server.component_initializer import ComponentInitializer
from context_lab.server.context_operations import ContextOperations
from context_lab.llm.global_embedding_client import GlobalEmbeddingClient
from context_lab.llm.global_vlm_client import GlobalVLMClient
from context_lab.config.global_config import GlobalConfig
from context_lab.storage.global_storage import GlobalStorage

logger = get_logger(__name__)


class ContextLab:
    """Context Lab main class - integrates all components and provides unified API."""
    ...
    def __init__(
        ...
        logger.info("Context Lab initialization completed")
    ...
    def _initialize_monitoring(self):
        ...
        try:
            from context_lab.monitoring import initialize_monitor
            initialize_monitor()
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Context Lab Server")
    ...
    print(f"Starting Context Lab Server on {args.host}:{args.port}")
    if args.config:
