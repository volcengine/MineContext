...
"""
Component initialization utilities for Context Lab.
Separated from main ContextLab class for better maintainability.
"""
...
from context_lab.context_processing.processor.processor_factory import ProcessorFactory
from context_lab.config.prompt_manager import PromptManager
...
from context_lab.context_consumption.generation import *
from context_lab.context_consumption.completion import CompletionService
...
class ComponentInitializer:
    """Handles initialization of various Context Lab components."""
    ...
    def _create_capture_component(self, name: str, config: Dict[str, Any]):
        ...
        if not module_path or not class_name:
            module_path = f"context_lab.context_capture.{name}"
    ...
    def _create_consumption_component(self, name: str, config: Dict[str, Any]):
        ...
        if not module_path or not class_name:
            module_path = f"context_lab.context_consumption.{name}"
