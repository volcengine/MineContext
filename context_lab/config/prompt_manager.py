...
class PromptManager:
    ...
    def get_context_type_descriptions(self) -> str:
        ...
        from context_lab.models.enums import get_context_type_descriptions_for_prompts
    ...
    def get_context_type_descriptions_for_extraction(self) -> str:
        ...
        """
        from context_lab.models.enums import get_context_type_descriptions_for_extraction
    ...
    def get_context_type_descriptions_for_retrieval(self) -> str:
        ...
        """
        from context_lab.models.enums import get_context_type_descriptions_for_retrieval
