...
from context_lab.context_processing.processor.entity_processor import refresh_entities, validate_and_clean_entities
from context_lab.models.context import *
from context_lab.utils.json_parser import parse_json_from_response
from context_lab.llm.global_vlm_client import generate_with_messages_async
...
from context_lab.utils.image import resize_image, calculate_phash
from context_lab.tools.tool_definitions import  ALL_TOOL_DEFINITIONS
import heapq
...
class ScreenshotProcessor(BaseContextProcessor):
    ...
    async def batch_process(self, raw_contexts: List[RawContextProperties]) -> bool:
        ...
        try:
            from context_lab.monitoring import record_processing_metrics
    ...
    async def _create_processed_contexts(self, raw_resp: Any, raw_contexts: List[RawContextProperties]) -> Tuple[List[ProcessedContext], List[str]]:
        ...
        for item in items_to_process:
            ...
            try:
                ...
                from context_lab.models.enums import get_context_type_for_analysis
