...
from context_lab.storage.unified_storage import ActivityStorageManager
from context_lab.llm.global_vlm_client import generate_with_messages
from context_lab.tools.tool_definitions import ALL_PROFILE_TOOL_DEFINITIONS, ALL_RETRIEVAL_TOOL_DEFINITIONS, ALL_TOOL_DEFINITIONS
from context_lab.utils.logging_utils import get_logger
from context_lab.models.enums import ContextType
from context_lab.models.context import ProcessedContext
from context_lab.models.enums import ContentFormat
...
class RealtimeActivityMonitor:
    ...
    def generate_realtime_activity_summary(self, start_time: int, end_time: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            from context_lab.managers.event_manager import EventType, publish_event
            publish_event(
