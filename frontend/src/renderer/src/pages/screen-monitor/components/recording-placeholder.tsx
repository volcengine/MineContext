...
const RecordingPlaceholder: React.FC<RecordingPlaceholderProps> = ({
  hasPermission,
  isToday,
  onGrantPermission
}) => {
        ...
        {hasPermission ? (
          ...
          <>
            ...
            <Button
              ...
              className="[&_.arco-btn-primary]:!mt-[24px] [&_.arco-btn-primary]:!font-medium [&_.arco-btn-primary]:!bg-black">
              Enable Permission
            </Button>
          </>
        )}
