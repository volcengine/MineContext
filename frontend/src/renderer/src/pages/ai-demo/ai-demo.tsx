  ...
  const [activeTab, setActiveTab] = useState('demo')
    ...
    return (
      <div className="h-screen flex overflow-hidden">
        {/* Main content area */}
        <div className={`flex-1 h-full p-6 overflow-y-auto relative transition-[width] duration-300 ease-in-out ${isSidebarOpen ? 'w-[calc(100%-400px)]' : ''}`}>
          ...
          <Button
            ...
            className="absolute right-6 top-1/2 -translate-y-1/2 z-[100] hover:-translate-y-1/2 hover:scale-110 transition-transform duration-200 ease-in-out"
          >
          </Button>
        </div>
