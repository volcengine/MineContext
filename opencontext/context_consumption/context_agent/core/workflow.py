...
from ..models.enums import WorkflowStage, EventType, ContextSufficiency, ReflectionType
...
class WorkflowEngine:
    ...
    def _init_nodes(self):
        ...
        if not self._nodes:
            ...
            self._nodes = {
                WorkflowStage.INTENT_ANALYSIS: IntentNode(
                ...
                WorkflowStage.REFLECTION: ReflectionNode(
                    streaming_manager=self.streaming_manager
                )
            }
