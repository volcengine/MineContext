...
class MetricsCollector:
    ...
    @staticmethod
    def timing_decorator(processor_name: str, operation: str, 
        ...
        def decorator(func: Callable) -> Callable:
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    logger.debug(f"Retrieval {operation} completed in {duration_ms}ms, {snippets_count} snippets")
            
            return wrapper
        return decorator
    
    @staticmethod
    def manual_timing_context(processor_name: str, operation: str, 
                             context_type: Optional[str] = None):
        """
        手动时间测量上下文管理器
